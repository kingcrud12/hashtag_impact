    ...
    >
      ...
      >
        <div style={{ maxWidth: "800px" }}>
          ...
          >
            Chaque m2 peut avoir un impact
          </h1>
          <p
            style={{
              fontSize: "1.25rem",
          ...
          >
            Repérez ou proposez des lieux sous-utilisés pour répondre à
            l'urgence sociale et accélérer la transition environnementale, grâce
            à un réseau de professionnels engagés.
          </p>
        </div>
